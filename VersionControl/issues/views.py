...
class Issues(APIView):
    ...
    def get(self, request, status, nameUser, params, id):
    ...
    def post(self, request):
        repositoryData = decode_post(request.body)
        data = {
        ...
        user = decode_post(repositoryData['user'])

        res = self.issueService.createNewIssue(user, data)
